        ...
        // {item.product.map(prod => (<span>{prod.product_name} {prod.price}</span>))}
         return <Item >
          ...
          <Item.Content>
            ...
            {item.product.map(prod => (<div>
          <Item.Image src={item.product.product_image} />
    
          <Item.Content>
            <Item.Header as='a'>{prod.product_name}</Item.Header>
            <Item.Meta>
              <span className='cinema'>Price{prod.price}</span>
            </Item.Meta>
